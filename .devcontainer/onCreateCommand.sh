...
wget https://github.com/ItzLevvie/artifacts/releases/download/29576-1/data.7z.001 --output-document /tmp/$REPOSITORY/windows/data.7z.001
wget https://github.com/ItzLevvie/artifacts/releases/download/29576-1/data.7z.002 --output-document /tmp/$REPOSITORY/windows/data.7z.002
wget https://github.com/ItzLevvie/artifacts/releases/download/29576-1/data.7z.003 --output-document /tmp/$REPOSITORY/windows/data.7z.003
wget https://github.com/ItzLevvie/artifacts/releases/download/29576-1/data.7z.004 --output-document /tmp/$REPOSITORY/windows/data.7z.004
wget https://github.com/ItzLevvie/artifacts/releases/download/29576-1/data.7z.005 --output-document /tmp/$REPOSITORY/windows/data.7z.005
